...
class TestRouteCalculator(unittest.TestCase):
    ...
    def test_Route_CalcuatorExample1(self):
        ...
        start_times = [time_to_seconds("3:00 PM"), time_to_seconds("3:15 PM"), time_to_seconds("3:25 PM"),
                       time_to_seconds("3:40 PM")]
    ...
    def test_Route_6Entries(self):
        ...
        locations = [pickup1, dropoff1, pickup2, dropoff2, pickup3, dropoff3, pickup4, dropoff4, pickup5, dropoff5,
                     pickup6, dropoff6]
    ...
    def test_Route_4trips4towns_sameTime(self):
        ...
        start_times = [time_to_seconds("12:00 PM"), time_to_seconds("12:10 PM"),
                       # smaller time window since drop off in cambridge
